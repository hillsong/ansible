...
---
cliconf: boss
short_description: Use boss cliconf to run command on Extreme BOSS platform
description:
  - This boss plugin provides low level abstraction apis for
    sending and receiving CLI commands from Extreme BOSS network devices.
version_added: "2.7"
"""
...
from ansible.module_utils.network.boss.boss import BossNetworkConfig
...
class Cliconf(CliconfBase):
    ...
    def get_diff(self, candidate=None, running=None, diff_match='line', diff_ignore_lines=None, path=None, diff_replace='line'):
        ...
        candidate_obj = BossNetworkConfig(indent=0, ignore_lines=diff_ignore_lines)
        candidate_obj.load(candidate)

        if running and diff_match != 'none':
            # running configuration
            running_obj = BossNetworkConfig(indent=0, contents=running, ignore_lines=diff_ignore_lines)
